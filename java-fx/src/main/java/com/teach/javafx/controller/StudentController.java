...
//保证邮箱格式正确
    ...
    protected void onSaveButtonClick() {
        ...
        if (!isValidEmail(emailField.getText())) {
            MessageDialog.showDialog("❌ 请输入正确的邮箱格式！");
            return;
        }
        // 3. 构建表单数据
        Map<String,Object> form = new HashMap<>();
        form.put("personId", personId); // 传递 personId
        form.put("studentId", studentId); // 传递 studentId
        ...
        if (genderComboBox.getSelectionModel() != null && genderComboBox.getSelectionModel().getSelectedItem() != null)
            ...
            form.put("gender", null); // 如果未选择性别，设为 null
        ...
        if (res != null && res.getCode() == 0) {
            ...
            if (res != null) {
                ...
                // 处理 res 为 null 的情况，例如显示错误信息
                System.err.println("Error: res is null");
            }
        }
    }
